	...
	var TodoApp = React.createClass({
		getInitialState : function(){
			return {Todo:[{name:"Grocery",items:[{item:'Cereal',isDone:false},{item:'Salty snacks',isDone:true},{item:'Milk',isDone:true},{item:'Bread',isDone:true}
			]},
      {name:"Stationery",items:[{item:'Pencil',isDone:false},{item:'Eraser',isDone:true},{item:'Ruler',isDone:true}
			]}],
      filter:[{keyword:'',Status:"SHOW_ALL"}],selectedCatelog:"0"};
		...
		deleteItem : function(index){
			var newtodo = this.state.Todo;
			var allItems = this.state.Todo[this.state.selectedCatelog].items.slice();
